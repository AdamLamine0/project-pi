...
import {
  ...
  lucideAward, lucideUsers, lucideX, lucideLogOut,
  lucideCreditCard, lucideTicket,
...
@Component({
  ...
  template: `
    <div class="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-label="Profile">
      ...
      <div class="relative rounded-2xl overflow-hidden flex" style="background:var(--surface); width:min(800px, calc(100vw - 24px)); height:min(620px, calc(100vh - 48px)); box-shadow:0 24px 64px rgba(0,0,0,0.28);">
        ...
        <div class="flex flex-col" style="width:220px; flex-shrink:0; background:var(--surface-subtle); border-right:1px solid var(--border-subtle);">
          <!-- Profile header -->
          <div class="relative" style="background:linear-gradient(135deg,#1F2937 0%,#1D1384 60%,#1D1384 100%); padding:24px 16px 20px; text-align:center;">
          ...
          <!-- Tab navigation -->
          <nav class="flex-1 flex flex-col gap-0.5" style="padding:12px 8px;">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
          ...
          @if (successMessage) {
            <div class="mx-6 mb-3 rounded-xl border px-4 py-2.5 text-xs" style="background:var(--badge-green-bg); border-color:transparent; color:var(--badge-green-text);">
              {{ successMessage }}
            </div>
          }
          @if (errorMessage) {
            <div class="mx-6 mb-3 rounded-xl border px-4 py-2.5 text-xs" style="background:var(--badge-red-bg); border-color:transparent; color:var(--badge-red-text);">
              {{ errorMessage }}
            </div>
          }
                ...
                <div class="mt-5 badge-grid">
                  @for (badge of badges; track badge.id) {
                    <div class="badge-card-local">
                      <div class="badge-card-local__icon" [style.background]="badgeTone(badge.type).bg">
