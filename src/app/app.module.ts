...
import { PublicEventDetailComponent } from './pages/public-event-detail/public-event-detail.component';
...
@NgModule({
  ...
  providers: [provideHttpClient(withInterceptors([jwtInterceptor])), DecimalPipe],
  bootstrap: [App],
})
