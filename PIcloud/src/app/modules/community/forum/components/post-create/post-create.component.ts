      ...
      <div class="create-card glass-panel">
        ...
        <div class="card-content">
          <form [formGroup]="form" (ngSubmit)="submit()" class="post-form">
            ...
            <mat-form-field appearance="outline" class="full-width custom-field" *ngIf="canSelectGroup">
              <mat-label>Associer à un groupe (Optionnel)</mat-label>
              <mat-select formControlName="groupId" placeholder="Sélectionnez un groupe">
                <mat-option value="">Aucun groupe</mat-option>
