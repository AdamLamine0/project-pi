...
export class ShaderBackgroundComponent implements AfterViewInit, OnDestroy {
  ...
  private readonly FRAG_SRC = `
    ...
    vec3 c1 = vec3(0.031, 0.071, 0.141);  // #081224 base
    vec3 c2 = vec3(0.063, 0.141, 0.376);  // #102260 deep navy-blue
    vec3 c3 = vec3(0.094, 0.373, 0.647);  // #185FA5 primary blue
    vec3 c4 = vec3(0.216, 0.541, 0.867);  // #378ADD bright blue
    vec3 c5 = vec3(0.039, 0.094, 0.220);  // #0a1838 dark navy accent
    vec3 c6 = vec3(0.357, 0.655, 0.910);  // #5ba7e8 highlight blue
    ...
    void main() {
      ...
      col = mix(col, vec3(1.0), gridLine * 0.10);
