...
@Component({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, MatCardModule, MatButtonModule, MatInputModule, MatFormFieldModule, MatSelectModule, MatIconModule, MatTableModule, MatProgressSpinnerModule],
  templateUrl: './investment-holding.html',
  styleUrl: './investment-holding.css',
})
export class InvestmentHolding implements OnInit, OnDestroy {
  requestId = '';
  request: InvestmentRequest | null = null;
  holding: InvestmentHoldingModel | null = null;
