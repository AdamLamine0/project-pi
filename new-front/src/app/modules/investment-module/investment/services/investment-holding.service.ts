...
export class InvestmentHoldingService {
  ...
  getHolding(holdingId: string, userId: string, role: HoldingRole): Observable<InvestmentHoldingModel> {
    return this.http.get<InvestmentHoldingModel>(
      `${this.baseUrl}/holding/${holdingId}`,
      { headers: this.buildHeaders(userId, role) }
    );
  }

  getHoldingByRequestId(requestId: string, userId: string, role: HoldingRole): Observable<InvestmentHoldingModel> {
    return this.http.get<InvestmentHoldingModel>(
  ...
  requestRelease(holdingId: string, userId: string, role: HoldingRole): Observable<InvestmentHoldingModel> {
    return this.http.post<InvestmentHoldingModel>(
  ...
  dispute(holdingId: string, userId: string, role: HoldingRole): Observable<InvestmentHoldingModel> {
    return this.http.post<InvestmentHoldingModel>(
  ...
  releaseFunds(holdingId: string, userId: string): Observable<InvestmentHoldingModel> {
    return this.http.post<InvestmentHoldingModel>(
  ...
  refund(holdingId: string, userId: string): Observable<InvestmentHoldingModel> {
    return this.http.post<InvestmentHoldingModel>(
  ...
  confirmCheckout(payload: ConfirmCheckoutPayload): Observable<InvestmentHoldingModel> {
    return this.http.post<InvestmentHoldingModel>(
