...
import { DataRoomComponent } from '../data-room/components/data-room/data-room.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    data: { title: 'Investment Criteria' },
  },
  {
    path: 'criteria',
  ...
  { path: 'edit-request/:id', component: RequestForm,data: { title: 'modifier la demande d’investissement' },},
  {
    ...
    data: { title: 'Data Room', roles: ['INVESTOR', 'ENTREPRENEUR'] },
  },
  {
    path: '**',
    redirectTo: '',
