...
public class InvestmentCriteriaController {
    ...
    public List<InvestmentCriteria> getByInvestor(@PathVariable String investorId){
        return investmentCriteriaService.getInvestmentCriteriaByInvestor(investorId);
    }
